...
<<?php print $layout_wrapper; print $layout_attributes; ?> class="<?php print $classes; ?>">
  ...
  <?php if ($topleft || $topright) : ?>
    <div class="row top-middle-row">
      <<?php print $topleft_wrapper; ?> class="top-left-wrapper col-sm-7 <?php print $topleft_classes; ?>">
        <?php print $topleft; ?>
      </<?php print $topleft_wrapper; ?>>
      <<?php print $topright_wrapper; ?> class="top-right-wrapper col-sm-5 <?php print $topright_classes; ?>">
        <?php print $topright; ?>
        <div class="btn btn-standard btn-shadow route-search"><a href="/140-routes"><i class="fal fa-search"></i>Find another route</a></div>
  ...
  <?php if ($bottomleft || $bottomright) : ?>
    <div class="row bottom-middle-row">
      <<?php print $bottomleft_wrapper; ?> class="bottom-left-wrapper col-sm-7 <?php print $bottomleft_classes; ?>">
        <?php print $bottomleft; ?>
      </<?php print $bottomleft_wrapper; ?>>
      <<?php print $bottomright_wrapper; ?> class="bottom-right-wrapper col-sm-5 <?php print $bottomright_classes; ?>">
