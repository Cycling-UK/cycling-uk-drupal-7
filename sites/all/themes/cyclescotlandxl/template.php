...
function cyclescotlandxl_theme(&$existing, $type, $theme, $path){
  $hooks = array();
...
function cyclescotlandxl_preprocess_user_register_form(&$vars) {
  $args = func_get_args();
  array_shift($args);
...
function cyclescotlandxl_preprocess_page(&$vars) {
...
function cyclescotlandxl_preprocess_node(&$vars, $hook) {
...
function cyclkescotlandxl_menu_link__menu_block($variables) {
  return theme_menu_link($variables);
}

function cyclescotlandxl_pager($vars) {
  $vars['tags'] = array('','','','','');
