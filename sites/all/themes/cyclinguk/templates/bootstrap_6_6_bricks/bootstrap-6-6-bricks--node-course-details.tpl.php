 ...
 *
 * Customised for Cycling UK as 6-6 bricks
 */
?>
...
<<?php print $layout_wrapper; print $layout_attributes; ?> class="<?php print $classes; ?>">
  ...
  <?php if ($topleft || $topright) : ?>
    <div class="row top-middle-row">
      <<?php print $topleft_wrapper; ?> class="top-left-wrapper col-sm-6 col-md-6 col-lg-6 <?php print $topleft_classes; ?>">
        <?php print $topleft; ?>
      </<?php print $topleft_wrapper; ?>>
      <<?php print $topright_wrapper; ?> class="top-right-wrapper col-sm-6 col-md-6 col-lg-6 <?php print $topright_classes; ?>">
        <?php print $topright; ?>
  ...
  <?php if ($central) : ?>
    <div class="row central-row">
      <<?php print $central_wrapper; ?> class="central-wrapper col-sm-12 col-md-8 col-md-offset-2 <?php print $central_classes; ?>">
        <?php print $central; ?>
  ...
  <?php if ($bottomleft || $bottomright) : ?>
    <div class="row bottom-middle-row">
	  <!--<a class="back-button" href="javascript:history.back()"><span class="back-button-icon"><i class="fa fa-angle-left"></i></span><span class="back-button-text">Back</span></a>-->
      <<?php print $bottomleft_wrapper; ?> class="bottom-left-wrapper col-sm-6 col-md-6 col-lg-6 <?php print $bottomleft_classes; ?>">
        <?php print $bottomleft; ?>
      </<?php print $bottomleft_wrapper; ?>>
      <<?php print $bottomright_wrapper; ?> class="bottom-right-wrapper col-sm-6 col-md-6 col-lg-6 <?php print $bottomright_classes; ?>">
