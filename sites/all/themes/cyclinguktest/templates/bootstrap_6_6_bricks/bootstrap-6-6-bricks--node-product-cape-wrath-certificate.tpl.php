...
<<?php print $layout_wrapper; print $layout_attributes; ?> class="<?php print $classes; ?>">
  ...
  <?php if ($top) : ?>
    <div class="row top-row">
      <<?php print $top_wrapper; ?> class="top-wrapper col-sm-8 col-sm-offset-2 <?php print $top_classes; ?>">
  ...
  <?php if ($bottom) : ?>
    <div class="row bottom-row">
      <<?php print $bottom_wrapper; ?> class="bottom-wrapper col-sm-8 col-sm-offset-2<?php print $bottom_classes; ?>">
        <?php print $bottom; ?>
