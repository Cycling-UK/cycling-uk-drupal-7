...
<a class="<?php print $stext; ?>" href="<?php print $node_url; ?>">
    ...
    if (isset($content['field_hero'])) {
      ...
      if ($content['field_hero']['#items'][0]['type'] !== 'video') {
        print render($content['field_hero']);
      } else {
        //print t('test1');
        print render($content['field_hero']);
        //print '<pre>';
        //print_r($content['field_hero']);
        //print '</pre>';
      }
      print '</span>';
      ...
      //print theme('image_style', array('style_name' => '320x205', 'attributes' => array( 'class' => 'b-lazy', 'id' => 'blazy'), 'path' => $content['field_image_gallery']['#items'][0]['uri']));
      print '</span>';
    } elseif (isset($content['field_group_image'])) {
      print '<span class="image">';
      print  render($content['field_group_image']);
      print '</span>';
    } elseif (isset($content['field_banner_image_paragraph'])) {
      print '<span class="image">';
      print render($content['field_banner_image_paragraph']);
      //print theme('image_style', array('style_name' => '320x205', 'attributes' => array( 'class' => 'b-lazy', 'id' => 'blazy'), 'path' => $content['field_banner_image_paragraph'][0][entity][paragraphs_item][1]['field_banner_image'][0]['#item']['uri']));
      print '</span>';
    }else { ?>
    <span class="image">
    ...
    <?php //<span class="btn btn-transparent"><span class="inner-container">View</span></span> ?>
</a>
