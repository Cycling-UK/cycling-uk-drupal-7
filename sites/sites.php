 ...
 */
 /*$sites['www.cyclinguk.org'] = 'default';
 $sites['cyclinguk.org'] = 'default'; */
 $sites['groups.cyclinguk.org'] = 'default';
 $sites['shop.cyclinguk.org'] = 'shop';

 //$sites['dev.cyclinguk.org'] = 'default';
 $sites['devshop.cyclinguk.org'] = 'shop';

 //$sites['newstage.cyclinguk.org'] = 'default';
 $sites['stageshop.cyclinguk.org'] = 'shop';

 $sites['ianshop.cyclinguk.org'] = 'shop';

 //$sites['ali.cyclinguk.org'] = 'default';
 $sites['alishop.cyclinguk.org'] = 'shop';
 $sites['cd1shop.cyclinguk.org'] = 'shop';
 $sites['cd2shop.cyclinguk.org'] = 'shop';


/*
 $sites['prod.cyclinguk.org'] = 'default';
 $sites['dev.cyclinguk.org'] = 'default';
 $sites['stage.cyclinguk.org'] = 'default';
 $sites['shop.cyclinguk.org'] = 'shop';
 $sites['prod.shop.cyclinguk.org'] = 'shop';
 $sites['stage.shop.cyclinguk.org'] = 'shop';
 $sites['devshop.cyclinguk.org'] = 'shop';
 $sites['stageshop.cyclinguk.org'] = 'shop';
 $sites['local.cyclinguk.org'] = 'default';
 $sites['localshop.cyclinguk.org'] = 'shop';
*/
