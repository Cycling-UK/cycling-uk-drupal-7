...
$databases = array (
  ...
  'default' => 
    array (
      'database' => 'groupsto_test',
      'username' => 'groupsto_test',
      'password' => 'g[2Np)430S',
      'host' => 'localhost',
      'port' => '',
      'driver' => 'mysql',
...
#  $base_url = 'https://www.cyclinguk.org';
#  $conf['care_database_to_use'] = 'live';
#} else {
#  $conf['care_database_to_use'] = 'test';
#}
/**
 * PHP settings:
 *
...
# $conf['form_cache_expiration'] = 21600;
 $conf['form_cache_expiration'] = 7200;
/**
 * String overrides:
 *
...
# );
$conf['locale_custom_strings_en'][''] = array(
  'Further instructions have been sent to your e-mail address.'      => 'Thank you for requesting a password reset for your account, if this email is registered with our site you should receive your password reset within 30 minutes, if you have not registered <a href="user/register">please register</a>, if you are already registered and are still having problems please <a href="/contact">contact our membership department</a>.',
#   '@count min' => '@count minutes',
);
/**
 *
...
if (file_exists('/var/www/site-php')) {
  require('/var/www/site-php/cyclinguk/cyclinguk-settings.inc');
}
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_prod_cyclinguk_dev_default.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_prod_cyclinguk_dev_default.inc';
}
// </DDSETTINGS>
...
// https://support.acquia.com/hc/en-us/articles/360005307793-Setting-the-private-file-directory-on-Acquia-Cloud


// *** DISABLED IN KRYSTAL MIGRATION ***
/*
...
// Following entries are bespoke settings from the old www.cyclinguk.org settings.php file
// STARTS
  ...
  /*
  if (isset($_ENV['AH_SITE_ENVIRONMENT']) && $_ENV['AH_SITE_ENVIRONMENT'] === 'prod') {
    $base_url = 'https://groups.cyclinguk.org';
    $conf['care_database_to_use'] = 'live';
  } else {
    $conf['care_database_to_use'] = 'test';
  }
  */
  ...
  /*encryption */
  $conf['encrypt_drupal_variable_key'] = 'OPinYh!ZDinZnweyD!';
  ...
  */
  ...
  // 4 October 2019 -- AAM
  // Load custom acquia.inc file for additional security restrictions
  // Restrict abnormal search requests from 66.249.*.* range
  // https://docs.acquia.com/acquia-cloud/arch/security/restrict/
...
//allows group images to be delivered to emails
