 ...
 *
 */
$drupal_hash_salt = '7F_lJgGJZl6smp_ViBdN4IyVX7N69-YKPzJSR3EkukQ';
 ...
 */
 if (isset($_ENV['AH_SITE_ENVIRONMENT']) && $_ENV['AH_SITE_ENVIRONMENT'] === 'prod') {
   $base_url = 'https://shop.cyclinguk.org';
 ...
 */
 $conf['locale_custom_strings_en'][''] = array(
   ...
   'Continue with checkout to complete payment via Mastercard' => 'Continue to complete payment via the Mastercard payment gateway (most cards excepted).',
...
/**
 * Acquia database connector.
 */
if (file_exists('/var/www/site-php')) {
  // Use the mysite database as our default database, but delay connecting.
  $conf['acquia_hosting_settings_autoconnect'] = FALSE;
  require('/var/www/site-php/cyclinguk/shop-settings.inc');

  // Use the drupal_shared database for users, sessions, and profiles.
  $shared = $databases['cyclinguk']['default']['database'] . '.';
  $databases['default']['default']['prefix'] = array(
    'default' => '',
    'authmap' => $shared,
    'field_data_field_membership_number' => $shared,
    'field_revision_field_membership_number' => $shared,
...
//$conf['devel_debug_mail_directory'] = '/var/www/html/temp';
...
$conf['environment_indicator_overwritten_name'] = 'Local Master';
$conf['environment_indicator_overwritten_color'] = '#ff5855';
