...
function cyclingukxl_theme(&$existing, $type, $theme, $path){
  $hooks = array();
  ...
  $hooks['user_register_form'] = array (
     ...
     'preprocess functions' => array('cyclingukxl_preprocess_user_register_form'),
  );
  return $hooks;
}

function cyclingukxl_preprocess_user_register_form(&$vars) {
  $args = func_get_args();
  array_shift($args);
...
function cyclingukxl_preprocess_page(&$vars) {
...
function cyclingukxl_preprocess_node(&$vars, $hook) {
 ...
 */
function cyclingukxl_menu_link__menu_block($variables) {
  return theme_menu_link($variables);
}


function cyclingukxl_pager($vars) {
  $vars['tags'] = array('','','','','');
 ...
 * @param $trail
 */
function cyclingukxl_superfish_active_trail_alter(&$trail) {
 ...
 */
function cyclingukxl_preprocess_superfish_menu_item(&$variables) {
