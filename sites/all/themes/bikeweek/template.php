...
function bikeweek_theme(&$existing, $type, $theme, $path){
  $hooks = array();
   // Make user-register.tpl.php available
  $hooks['user_register_form'] = array (
     'render element' => 'form',
     'path' => drupal_get_path('theme','bikeweek'),
     'template' => 'user-register-form',
     'preprocess functions' => array('bikeweek_preprocess_user_register_form'),
  );
  return $hooks;
}

function bikeweek_preprocess_user_register_form(&$vars) {
  $args = func_get_args();
  array_shift($args);
...
/*
function bikeweek_preprocess_page(&$vars) {
...
function bikeweek_preprocess_node(&$vars, $hook) {
 ...
 */
function bikeweek_menu_link__menu_block($variables) {
  return theme_menu_link($variables);
}


function bikeweek_pager($vars) {
  $vars['tags'] = array('','','','','');
 ...
 * @param $trail
 */
function bikeweek_superfish_active_trail_alter(&$trail) {
 ...
 */
function bikeweek_preprocess_superfish_menu_item(&$variables) {
