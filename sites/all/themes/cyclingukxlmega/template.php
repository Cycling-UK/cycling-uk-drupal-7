...
function cyclingukxlmegamega_theme(&$existing, $type, $theme, $path){
  $hooks = array();
   // Make user-register.tpl.php available
  $hooks['user_register_form'] = array (
     'render element' => 'form',
     'path' => drupal_get_path('theme','cyclingukxlmega'),
     'template' => 'user-register-form',
     'preprocess functions' => array('cyclingukxlmega_preprocess_user_register_form'),
  );
  return $hooks;
}

function cyclingukxlmega_preprocess_user_register_form(&$vars) {
  $args = func_get_args();
  array_shift($args);
...
function cyclingukxlmega_preprocess_page(&$vars) {
...
function cyclingukxlmega_preprocess_node(&$vars, $hook) {
 ...
 */
function cyclingukxlmega_menu_link__menu_block($variables) {
  return theme_menu_link($variables);
}


function cyclingukxlmega_pager($vars) {
  $vars['tags'] = array('','','','','');
 ...
 * @param $trail
 */
function cyclingukxlmega_superfish_active_trail_alter(&$trail) {
 ...
 */
function cyclingukxlmega_preprocess_superfish_menu_item(&$variables) {
