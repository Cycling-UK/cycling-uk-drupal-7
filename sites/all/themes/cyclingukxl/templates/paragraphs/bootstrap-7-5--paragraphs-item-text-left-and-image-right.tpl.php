...
<div class="remove-gutter 
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <<?php print $right_wrapper; ?> class="right-col col-xs-12 col-sm-5 col-sm-push-7 <?php print $right_classes; ?>">
      <?php print $right; ?>
      </<?php print $right_wrapper; ?>>

      <<?php print $left_wrapper; ?> class="left-col col-xs-12 col-sm-7 col-sm-pull-5 <?php print $left_classes; ?>">
      <?php print $left; ?>
