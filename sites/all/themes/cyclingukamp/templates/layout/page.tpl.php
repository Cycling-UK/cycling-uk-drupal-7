...
<amp-sidebar id='sidebar' layout='nodisplay' side='right'>
	<?php
	    $main_menu_tree = menu_tree(variable_get('menu_main_links_source', 'menu-amp-menu')); 
...
<div id="page-wrapper"><div id="page">
	...
	<div class="top-container top-menu-container">
		...
		<div class="amp-header__content">
			...
			<div class="left-container">
				<a class="logo" href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>">
					<amp-img src="/sites/all/themes/cyclingukamp/logo.png" alt="<?php print t('Home'); ?>" height="64" width="172" layout="responsive"></amp-img>
				</a>
			</div>

			<div class="right-container">
				<button on="tap:sidebar.toggle" class="ampstart-btn caps m2"><i class="fa fa-bars"></i></button>
			</div>
