...
<<?php print $layout_wrapper; print $layout_attributes; ?> class="<?php print $classes; ?>">
  ...
  <?php if ($topleft || $topright) : ?>
    <div class="row top-middle-row">
      <<?php print $topleft_wrapper; ?> class="top-left-wrapper col-sm-8 <?php print $topleft_classes; ?>">
        <?php print $topleft; ?>
      </<?php print $topleft_wrapper; ?>>
      <<?php print $topright_wrapper; ?> class="top-right-wrapper col-sm-4 <?php print $topright_classes; ?>">
        <?php print $topright; ?>
  ...
  <?php if ($bottomleft || $bottomright) : ?>
    <div class="row bottom-middle-row">
      <<?php print $bottomleft_wrapper; ?> class="bottom-left-wrapper col-sm-8 <?php print $bottomleft_classes; ?>">
        <?php print $bottomleft; ?>
      </<?php print $bottomleft_wrapper; ?>>
      <<?php print $bottomright_wrapper; ?> class="bottom-right-wrapper col-sm-4 <?php print $bottomright_classes; ?>">
