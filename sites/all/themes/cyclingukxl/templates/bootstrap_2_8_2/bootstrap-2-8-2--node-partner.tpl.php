...
<<?php print $layout_wrapper; print $layout_attributes; ?> class="<?php print $classes; ?>">
  ...
  <div class="row">
    ...
    <<?php print $central_wrapper; ?> class="col-sm-8 col-md-6 page-content <?php print $central_classes; ?> <?php echo isset($node->field_partner_type['und'][0]['value'])? $node->field_partner_type['und'][0]['value']:''; ?>">
      <?php print $central; ?>
