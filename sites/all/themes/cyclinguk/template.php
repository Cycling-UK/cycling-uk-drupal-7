...
function cyclinguk_theme(&$existing, $type, $theme, $path){
  $hooks = array();
   // Make user-register.tpl.php available
  $hooks['user_register_form'] = array (
     'render element' => 'form',
     'path' => drupal_get_path('theme','cyclinguk'),
     'template' => 'user-register-form',
     'preprocess functions' => array('cyclinguk_preprocess_user_register_form'),
  );
  return $hooks;
}

function cyclinguk_preprocess_user_register_form(&$vars) {
  $args = func_get_args();
  array_shift($args);
...
function cyclinguk_preprocess_page(&$vars) {
...
*/
/*
function cyclinguk_preprocess_html(&$variables) {
  if (in_array('page-membership-renew', $variables['classes_array'])) {
    $variables['classes_array'][] = 'page-layout-shop-membership';
  }
}
*/
...
function cyclinguk_preprocess_node(&$vars, $hook) {
 ...
 */
function cyclinguk_menu_link__menu_block($variables) {
  return theme_menu_link($variables);
}


function cyclinguk_pager($vars) {
  $vars['tags'] = array('','','','','');
 ...
 * @param $trail
 */
function cyclinguk_superfish_active_trail_alter(&$trail) {
 ...
 */
function cyclinguk_preprocess_superfish_menu_item(&$variables) {
