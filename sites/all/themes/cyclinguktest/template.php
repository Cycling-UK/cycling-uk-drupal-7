...
function cyclinguktest_theme(&$existing, $type, $theme, $path){
  $hooks = array();
   // Make user-register.tpl.php available
  $hooks['user_register_form'] = array (
     'render element' => 'form',
     'path' => drupal_get_path('theme','cyclinguktest'),
     'template' => 'user-register-form',
     'preprocess functions' => array('cyclinguktest_preprocess_user_register_form'),
  );
  return $hooks;
}

function cyclinguktest_preprocess_user_register_form(&$vars) {
  $args = func_get_args();
  array_shift($args);
...
function cyclinguktest_preprocess_page(&$vars) {
...
function cyclinguktest_preprocess_node(&$vars, $hook) {
 ...
 */
function cyclinguktest_menu_link__menu_block($variables) {
  return theme_menu_link($variables);
}


function cyclinguktest_pager($vars) {
  $vars['tags'] = array('','','','','');
 ...
 * @param $trail
 */
function cyclinguktest_superfish_active_trail_alter(&$trail) {
 ...
 */
function cyclinguktest_preprocess_superfish_menu_item(&$variables) {
