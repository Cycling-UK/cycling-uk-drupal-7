...
function londonbikeshow_theme(&$existing, $type, $theme, $path){
  $hooks = array();
   // Make user-register.tpl.php available
  $hooks['user_register_form'] = array (
     'render element' => 'form',
     'path' => drupal_get_path('theme','londonbikeshow'),
     'template' => 'user-register-form',
     'preprocess functions' => array('londonbikeshow_preprocess_user_register_form'),
  );
  return $hooks;
}

function londonbikeshow_preprocess_user_register_form(&$vars) {
  $args = func_get_args();
  array_shift($args);
...
function londonbikeshow_preprocess_page(&$vars) {
...
function londonbikeshow_preprocess_node(&$vars, $hook) {
 ...
 */
function londonbikeshow_menu_link__menu_block($variables) {
  return theme_menu_link($variables);
}


function londonbikeshow_pager($vars) {
  $vars['tags'] = array('','','','','');
 ...
 * @param $trail
 */
function londonbikeshow_superfish_active_trail_alter(&$trail) {
 ...
 */
function londonbikeshow_preprocess_superfish_menu_item(&$variables) {
