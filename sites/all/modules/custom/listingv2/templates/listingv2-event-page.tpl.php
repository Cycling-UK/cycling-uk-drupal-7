<script id="tablerow" type="x-tmpl-mustache">
  <tr class="wkts{{ index }}">
  <td class="views-field views-field-nothing"><a href="{{ url }}">{{ title }}</a></td>
  <td class="views-field views-field-nothing">{{ contentType }}</td>
  <td class="views-field views-field-field-group-activities">{{ date }}</td>
  </tr>
</script>
...
<section id="openlayer_map" class="block block-openlayers-block clearfix">
  <div id="openlayer-map-event" class="openlayers-map groups_map">
  </div>
</section>
      ...
      <table class="views-table cols-2 table table-hover table-striped">
        <thead>
          <tr>
            ...
            <th class="views-field views-field-field-event-type">Type</th>
            <th class="views-field views-field-field-event-date">Date</th>
          </tr>
        </thead>
        <tbody>
        </tbody>
